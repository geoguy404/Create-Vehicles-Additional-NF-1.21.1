...
import de.srr.createvehiclesadditional.content.fluids.pipes.CVAPipeModelData;
...
public class PipeAttachmentModelMixin extends BakedModelWrapperWithData {
    ...
    private static final ModelProperty<CVAPipeModelData> PIPE_PROPERTY = new ModelProperty<>();
    ...
    protected ModelData.Builder gatherModelData(ModelData.Builder builder, BlockAndTintGetter world, BlockPos pos, BlockState state,
        ...
        CVAPipeModelData data = new CVAPipeModelData();
    ...
    public List<BakedQuad> getQuads(BlockState state, Direction side, RandomSource rand, ModelData data, RenderType renderType) {
        ...
        if (data.has(PIPE_PROPERTY)) {
            CVAPipeModelData pipeData = data.get(PIPE_PROPERTY);
    ...
    private void addQuads(List<BakedQuad> quads, BlockState state, Direction side, RandomSource rand, ModelData data,
                          CVAPipeModelData pipeData, RenderType renderType) {

package de.srr.createvehiclesadditional.content.kinectics.elementSeparator;
...
public class ElementSeparatorRenderer extends SafeBlockEntityRenderer<ElementSeparatorBlockEntity> {
    ...
    protected void renderShaft(ElementSeparatorBlockEntity be, PoseStack ms,
        ...
        CachedBuffers.partial(CVAPartialModels.SEPARATOR_SHAFT, be.getBlockState())
                .light(light)
    ...
    protected void renderLid(ElementSeparatorBlockEntity be, PoseStack ms,
        ...
        CachedBuffers.partial(CVAPartialModels.SEPARATOR_LID1, be.getBlockState())
                .light(light)
        ...
        CachedBuffers.partial(CVAPartialModels.SEPARATOR_LID2, be.getBlockState())
                .light(light)
                .renderInto(ms, buffer.getBuffer(RenderType.cutout()));
        ms.popPose();
